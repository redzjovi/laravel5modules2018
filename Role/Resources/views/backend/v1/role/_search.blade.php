<form action="{{ route('modules.role.backend.v1.role.index') }}" method="GET">
    <div class="card">
        ...
        <div class="collapse" id="collapse_search">
            ...
            <div class="card-footer">
                ...
                <a class="btn btn-secondary btn-sm" href="{{ route('modules.role.backend.v1.role.index') }}">
                    <i class="fas fa-sync"></i>
                </a>
                <a class="btn btn-primary btn-sm" href="{{ route('modules.role.backend.v1.role.export-csv', request()->query()) }}">
