<form action="{{ route('modules.category.backend.v1.category.index') }}" method="GET">
    <div class="card">
        ...
        <div class="collapse" id="collapse_search">
            ...
            <div class="card-footer">
                ...
                <a class="btn btn-secondary btn-sm" href="{{ route('modules.category.backend.v1.category.index') }}">
                    <i class="fas fa-sync"></i>
                </a>
                <a class="btn btn-primary btn-sm" href="{{ route('modules.category.backend.v1.category.export-csv', request()->query()) }}">
